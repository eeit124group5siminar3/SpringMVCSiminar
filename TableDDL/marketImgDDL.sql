...
';
REM INSERTING into ROOT.MARKET_PRODUCT_IMG
SET DEFINE OFF;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "ROOT"."MARKET_PRODUCT_IMG_PK" ON "ROOT"."MARKET_PRODUCT_IMG" ("PRODUCT_ID") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "ROOT"."MARKET_PRODUCT_IMG" ADD CONSTRAINT "MARKET_PRODUCT_IMG_PK" PRIMARY KEY ("PRODUCT_ID")
