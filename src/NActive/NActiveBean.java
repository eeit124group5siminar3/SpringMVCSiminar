...
public class NActiveBean implements Serializable{
...
public NActiveBean(String act_id, String act_name, String act_addr, String tel, int exp_num, int act_num,
		String sig_stat, String member_no, Date act_date, Date date_sta, Date date_end, int price, String act_type,
		Clob act_descri, String img_name, Blob act_img, String vid_name, Blob act_video) {
	super();
	this.act_id = act_id;
