...
public class ActiveHomeController {
	...
	public String processInsert(
		...
		@RequestParam("actAddr") String actAddr,
		@RequestParam("tel") String tel,
		@RequestParam("actDate") Date actDate,
		@RequestParam("dateSta") Date dateSta,
		@RequestParam("dateEnd") Date dateEnd,
		@RequestParam("expNum") int expNum,
...
//		return "active/ActiveSucc";
	...
	public String processUpdate(
		...
		Active aBean = new Active(actId,actName,actType,actAddr,tel,actDate,dateSta,dateEnd,expNum,price,actDescri);
