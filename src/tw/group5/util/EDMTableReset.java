...
//			try {
//				try {
//					stmt.executeUpdate(DBService_for_Oracle.getDropOrderItems());
//					System.out.println("OrderItems表格刪除成功");
//				} catch (Exception ex) {
//					System.out.println("ex=" + ex);
//				}
//				stmt.executeUpdate(DBService_for_Oracle.getCreateOrderItems());
...
//		int n = 0;
//		String sqlS = "INSERT INTO Book " + " (title,  author,  price, discount, "
...
//			pStmt.setBlob(8, bean.getCoverImage().getBinaryStream());
...
//			ps.setBlob(10, mb.getMemberImage().getBinaryStream());
//			ps.setString(11, mb.getFileName());
////			ps.setClob(12, mb.getComment());
//			ps.setCharacterStream(12, mb.getComment().getCharacterStream());
