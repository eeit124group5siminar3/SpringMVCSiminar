...
@WebFilter(urlPatterns = {"/mall_order","/mall_management","/mall_manageOrder","/Mall_checkout","/blog_personal","/blogEdit","/mall_wishList"}, initParams = @WebInitParam(name = "LOGIN_PATH", value = "Member_Login"))
