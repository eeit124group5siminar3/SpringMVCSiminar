...
public class ResetPasswordTest_Servler extends HttpServlet {
	...
	public ResetPasswordTest_Servler() {
		super();
	}
...
//			gotoConfirmProcess(request, response);
	...
	public void gotoSubmitProcess(HttpServletRequest request, HttpServletResponse response)
		...
		String sel_email = select.reset_password(member_email, id_upper, member_name, member_cellphone);
