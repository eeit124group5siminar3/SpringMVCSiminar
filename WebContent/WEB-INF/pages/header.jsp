...
<%-- 							href="<c:url value='updatePage.controller'/>">我的食譜</a>  --%>
				...
				<li class="nav-item dropdown"><c:if test="${empty login_ok}">
						...
						<form class="nav-link"name="form_mall" action="memberUpdate.controller" method="post">
						<a href="javascript:document.form_mall.submit();" style="font-size: 20px;color:black">會員</a></form>
					</c:if></li>
