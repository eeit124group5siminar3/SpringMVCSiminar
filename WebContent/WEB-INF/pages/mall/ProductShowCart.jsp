				...
				<TABLE border='1'>
					<TR>
						<TD width="265" align='center'><A
							href="<c:url value='/RetrievePageProducts?pageNo=${pageNo}' />">繼續購物</A>
						</TD>
						<TD width="265" align='center'><A
							href="<c:url value='/CheckoutServlet' />"
							onClick="return Checkout(${subtotal});">再次確認</A></TD>
						<TD width="265" align='center'><A
							href="<c:url value='/AbortServlet' />" onClick="return Abort();">放棄購物</A>
						</TD>
					</TR>
				</TABLE>
			</TD>
