...
// 		document.forms[0].finalDecision.value = "CANCEL";
		document.forms[0].action="<c:url value='/DeleteOrderServlet' />";
...
function reconfirmOrder() {
	...
	var sa2 = document.getElementById('tel').value;
...
<h3>請確認下列訊息：</h3>
<FORM style="margin: 0 auto; width:750px;" action="<c:url value='ProcessOrderServlet' />" method="POST" >
   <TABLE border='1' style="background:#F5EBFF; border-color:rgb( 100, 100, 255); border-style: outset; width:810;">
      <TR >
         <TD style="text-align:left; border-color: #FFBD32; border-style: ridge;">
         	會員編號：${login_ok.member_no}
         </TD>
         <TD style="text-align:left; border-color: #FFBD32; border-style: ridge;">
         	客戶姓名：${login_ok.member_name}
         </TD>
         <TD style="text-align:left; border-color: #FFBD32; border-style: ridge;">
      ...
      <TR>
         <TD colspan='3' style="text-align:left; border-color: #FFBD32; border-style: ridge;">
                             連絡電話：<Input style="background:#ECFFCD;" size="60" type="text" id='tel' 
                   name="tel" value="">
                   <font color='red'>${errorMsg.tel}</font>
         </TD>
      </TR>
      <TR>
         <TD colspan='3' style="text-align:left; border-color: #FFBD32; border-style: ridge;">
   ...
   <TABLE border='1' style="background:#FFE7CD; border-color:rgb( 100, 100, 255); " >
     ...
     <TR><TH style="text-align:center;font-size: 12pt;" width="230">產品名稱</TH>
         <TH style="text-align:center;font-size: 12pt;" width="200">生產者</TH>
         <TH style="text-align:center;font-size: 12pt;" width="80">內含</TH>
     ...
     <c:forEach varStatus="vs" var="anEntry" items="${ShoppingCart.content}">
        ...
        <TR height='16'>
          <TD style="text-align:left  ;font-size: 11pt;">${anEntry.value.product}</TD>
          <TD style="text-align:center;font-size: 11pt;">
          	${anEntry.value.producterName}
          </TD>
          <TD style="text-align:center;font-size: 11pt;">
          	${anEntry.value.content}${anEntry.value.unit}
          </TD>
          <TD style="text-align:right ;font-size: 11pt;">
          	<fmt:formatNumber value="${anEntry.value.price * anEntry.value.discount }" pattern="#,###" />元
          </TD>
          <TD style="text-align:right ;font-size: 11pt;"> 
          	${anEntry.value.qty}
          </TD>
