...
// 		setMessageInnerHTML("");
	...
	function setMessageInnerHTML(innerHTML) {
		...
		$.ajax({
			...
			contentType : 'application/x-www-form-urlencoded;charset=UTF-8',
			success : function(data) {
				console.log($("#abc"+member_name).html());
			}
		});
	}
	//關閉WebSocket連線
...
$(document).ready(function(){
    $(".chat_on").click(function(){
       ...
       $.ajax({
			url :"admin_websocket_content_windows.controller",
			data : {
			},
			type : "POST",
			success : function(data) {
       ...
       $.ajax({
			url :"admin_websocket_content_windows_all.controller",
			data : {
			},
			type : "POST",
			success : function(data) {
               ...
               var Data=data;
             for(var key in Data) { 
                 $(".msg_history").append("<div style='display:none;color:black' class='received_msg' id=abc"+key+"></div>");
                 
         		$("#abc"+key).html(Data[key]);
               }
			}
		});
