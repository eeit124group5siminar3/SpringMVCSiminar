    ...
    <div class="card card-info" style="width: 50rem; ">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <form:input path="actName" type="text" class="form-control"/>
        </div>
        <!-- /.form group -->
        <div class="form-group">
          <form:label path="actType">活動類型:</form:label>
          <form:select path="actType" type="text" class="form-control">		
        ...
        <div class="form-group">
          ...
          <form:input path="actAddr" type="text" class="form-control"/>
        </div>
        <!-- /.form group -->
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="form-inline">
          	<form:input path="actDateSta" type="date" class="form-control col" />&emsp;&emsp;
          	<form:input path="actTimeSta"  type="time" class="form-control col" />
          </div>
        </div>
        <!-- /.form group -->
        <div class="form-group">
          ...
          <div class="form-inline">
          	<form:input path="actDateEnd" type="date" class="form-control col" />&emsp;&emsp;
          	<form:input path="actTimeEnd"  type="time" class="form-control col" />
          </div>
        </div>
        <!-- /.form group -->
        <div class="form-group">
          <form:label path="numLim">活動人數上限:</form:label>
          <form:input path="numLim" type="text" class="form-control" />
        </div>
        <!-- /.form group -->
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="form-inline">
           <img height='230' width='200' src="<c:url value='ActImageController?id=${afBean.actId}&type=ACTFARMER'/>"/>&emsp;
           <form:input path="multipartFile" type="file" class="align-self-end" id="imgInp" accept="image/*"/>
		   <img height='230' width='200' id="blah" src="#" alt="上傳新照片" />
          </div>
          <div class="form-inline">
        ...
        <div class="form-group">
          ...
          <form:textarea path="actDescri" class="form-control" style="height:200px" ></form:textarea>
        </div>
        <!-- /.form group -->
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="form-inline">
          	<form:input path="signDateEnd" type="date" class="form-control col" />&emsp;&emsp;
          	<form:input path="signTimeEnd"  type="time" class="form-control col" />
          </div>
        </div>
        <!-- /.form group -->
        <div class="form-group">
          ...
          <div class="form-inline" >
            <form:radiobutton path="sigStat" value="0" id="sigStat" />報名未開放&emsp;&emsp;
