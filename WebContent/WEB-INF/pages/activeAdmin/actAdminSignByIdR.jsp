...
<section class="content-wrapper d-flex justify-content-center">
  <form:form action="actAdminPreSignU.do" modelAttribute="aoBean" method="POST" enctype="multipart/form-data" name="actAdmin">
    <div class="card card-info" style="width: 50rem; ">
      <div class="card-header" style="background-color: #e6e1d3;">
        <span class="card-title" style="font-size: 40px;font-weight:bold;color:#594a2d">報名訂單檢視 </span>
      ...
      <div class="form-group">
        ...
        <!-- /.form group -->
         <div class="form-group">
          ...
          <div class="form-inline">
	          ...
	          <form:button readonly="true" class="btn btn-primary py-2 px-3 col-2" value="read" onclick="readAct()">查看活動</form:button>
          </div>
        </div>
        <!-- /.form group -->
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="form-inline" >
            <form:radiobutton path="ordState" value="0" id="sigStat" disabled="true"/>尚未付款&emsp;&emsp;
			<form:radiobutton path="ordState" value="1" id="sigStat" disabled="true"/>已付款&emsp;&emsp;
			<form:radiobutton path="ordState" value="2" id="sigStat" disabled="true"/>訂單取消
          </div>
        </div>
        <!-- /.form group -->
        <div class="form-group">
