...
$("#signup_form").on("submit",function(ev){
	...
	success:function(data){
		if(data[5] == "1"){
			window.location.href = "goFbCheckMemberSignUp.controller";
		}if(data[1] == "3"){
				...
				<div class="form-row">
					<div class="form-group col-md-6">
						<label for="inputEmail4">帳號</label> <input type="text"
							...
							value="<jsp:getProperty name="login_ok" property="member_email" />"
							disabled>
					</div>
					...
					<div class="form-group col-md-6" style="text-align:center">
						<label for="inputPassword4" style="float:left">名稱</label> <input type="text"
							...
							value="<jsp:getProperty name="login_ok" property="member_name" />"
							disabled>
						<p></p>
