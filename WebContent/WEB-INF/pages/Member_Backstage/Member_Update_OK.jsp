	...
	<div id="backstage_page">
		...
		<div class="signup-form container">
			<fieldset class="border signup-form-fieldset">
				...
				<c:if test="${login_ok.member_permissions =='0'}">
				...
				<div class="form-row">
					<div class="form-group col-md-6">
						<label for="inputEmail4">帳號</label> <input type="text"
							...
							placeholder="<jsp:getProperty name="login_ok" property="member_email" />"
							disabled>
					</div>
					<div class="form-group col-md-6">
				...
				<div class="form-group">
					<label for="inputAddress">地址</label> <input type="text"
						...
						placeholder="<jsp:getProperty name="login_ok" property="member_address" />"
						disabled>
				</div>

				<div class="form-row">
					<div class="form-group col-md-6">
						<label for="inputEmail4">統一編號</label>
						<c:if test="${login_ok.member_gui_number == null}">
							<input type="text" class="form-control" disabled>
						</c:if>
						<c:if test="${login_ok.member_gui_number != null}">
							<input type="text" name="member_gui_number" class="form-control"
								placeholder="<jsp:getProperty name="login_ok"
