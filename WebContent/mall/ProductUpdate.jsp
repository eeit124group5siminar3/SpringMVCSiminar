...
<form id="form1" name="form1" 
      method="post" action="ProductUpdateServlet" 
...
<table  class="table_color" width="608" border="2" align="center" 
   ...
   <tr height='36'>
    ...
    <tr height='36'>
        ...
        <td width="350">
            <input class='InputClass' name="discount" type="text" id="discount" 
               value="${discount}" size="6" />
            <Font color='red' size='-1'>
               ${ErrMsg.errDiscount}
            </Font>
        </td>
...
<td colspan='6' align='center'>
  <input name="productId" type="hidden" id="productId" value="${param.ProductId }>" />        
