...
<jsp:include page="/top.jsp" />
	...
	<form action="..\Member_SignUp_Servlet" method="post">
		<table cellspacing="2" cellpadding="1" border="1" width="100%">
			...
			<tr>
				<td>密碼</td>
				<td><input type="text" name="member_password" minlength="8" size="30"
					maxlength="20" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)[a-zA-Z\d]{8,}$" title="密碼長度至少8碼，須包含大寫、小寫英文及數字" placeholder="password" required></td>
			</tr>
			<tr>
				<td>身分證字號</td>
				<td><input type="text" name="member_id" size="15"
					maxlength="10" pattern="^[A-Za-z]\d{9}$" title="身分證格式錯誤" placeholder="A123456789" required></td>
			</tr>
			<tr>
				<td>姓名</td>
				<td><input type="text" name="member_name" size="30"
					pattern="^[\u4e00-\u9fa5]{0,}$" title="只接受中文字" placeholder="王小明" required></td>
			</tr>
			<tr>
				<td>生日</td>
				<td><input type="date" name="member_birthday" pattern="\d{4}\-?\d{2}\-?\d{2}" placeholder="yyyy-MM-dd" onkeydown="return false" required></td>
			</tr>
			<tr>
				<td>電話</td>
				<td><input type="text" name="member_cellphone" "pattern="09\d{8}" title="格式錯誤，例0900111222" placeholder="0900123456" required></td>
			</tr>
			<tr>
				<td>地址</td>
				<td><input type="text" name="member_address" size="50"
					pattern="^[\u4e00-\u9fa5\d]{0,}$" placeholder="桃園市中壢區中大路300號" required></td>
			</tr>
			<tr>
				<td>統一編號</td>
